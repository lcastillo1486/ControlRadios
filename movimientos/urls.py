...
urlpatterns = [
    ...
    path('formregistrafactura/<int:id>/<str:cliente>/<str:ruc>/<str:id_salida>',views.form_registra_fact),
    path('formregistrafacturanosunat/<int:id>/<str:cliente>/<str:ruc>/<str:id_salida>',views.form_registra_fact_no_sunat),
